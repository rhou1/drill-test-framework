...
alter session set `planner.memory.max_query_memory_per_node` = 1104857600;
...
create table dfs.drillTestDir.xsort_ctas2_multiple partition by (c_first_name) as
...
select count(*) from dfs.drillTestDir.xsort_ctas2_multiple;
drop table dfs.drillTestDir.xsort_ctas2_multiple;
